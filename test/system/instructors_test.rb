...
class InstructorsTest < ApplicationSystemTestCase
  ...
  test "creating a Instructor" do
    ...
    fill_in "Easiness", with: @instructor.easiness
    fill_in "Helpfulness", with: @instructor.helpfulness
    fill_in "Name", with: @instructor.name
    fill_in "Overall", with: @instructor.overall
    fill_in "Pedagogy", with: @instructor.pedagogy
