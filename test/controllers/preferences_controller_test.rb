...
class PreferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create preference" do
    assert_difference('Preference.count') do
      post preferences_url, params: { preference: { choice1: @preference.choice1, choice2: @preference.choice2, choice3: @preference.choice3 } }
    end
  ...
  test "should update preference" do
    patch preference_url(@preference), params: { preference: { choice1: @preference.choice1, choice2: @preference.choice2, choice3: @preference.choice3 } }
