...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { easiness: @instructor.easiness, helpfulness: @instructor.helpfulness, name: @instructor.name, overall: @instructor.overall, pedagogy: @instructor.pedagogy } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { easiness: @instructor.easiness, helpfulness: @instructor.helpfulness, name: @instructor.name, overall: @instructor.overall, pedagogy: @instructor.pedagogy } }
